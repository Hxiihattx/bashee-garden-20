...
const Hero = () => {
  ...
  return <section className="relative min-h-[90vh] lg:min-h-[80vh] overflow-hidden lg:pt-16">
      ...
      {/* Mobile Layout: Just the image */}
      <div className="lg:hidden">
        <div className="w-full">
          <img src="/lovable-uploads/a6cebc27-f7ae-42a7-921d-89d477faf42a.png" alt="Gamepad Control Lawnmower" className="w-full h-auto object-cover" />
        </div>
      </div>
